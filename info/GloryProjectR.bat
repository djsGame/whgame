...
call  cocos luacompile -s ..\client\client -d ..\client\ciphercode\client -e -k game766电玩_www.01cc.net_key!!! -b game766电玩_www.01cc.net_sign!!! --disable-compile
if  errorlevel 1 goto CipherSrcError
call  cocos luacompile -s ..\client\game -d ..\client\ciphercode\game -e -k game766电玩_www.01cc.net_key!!! -b game766电玩_www.01cc.net_sign!!! --disable-compile
if  errorlevel 1 goto CipherSrcError
call  cocos luacompile -s ..\client\base -d ..\client\ciphercode\base -e -k game766电玩_www.01cc.net_key!!! -b game766电玩_www.01cc.net_sign!!! --disable-compile
if  errorlevel 1 goto CipherSrcError
call  cocos luacompile -s ..\client\command -d ..\client\ciphercode\command -e -k game766电玩_www.01cc.net_key!!! -b game766电玩_www.01cc.net_sign!!! --disable-compile
if  errorlevel 1 goto CipherSrcError
...
call  cocos compile -p android --ap android-20 -m release --compile-script 0 -j 4
POPD
