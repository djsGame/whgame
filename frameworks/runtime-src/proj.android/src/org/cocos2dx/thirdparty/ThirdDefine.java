...
public class ThirdDefine {
	...
	//分享链接
	public static String  ShareURL = "http://www.xiaoshumei.cn";
	//分享标题
	public static String   ShareTitle = "小树梅棋牌游戏";
	//分享内容
	public static String   ShareContent = "小树梅棋牌游戏欢迎您http://www.xiaoshumei.cn";
