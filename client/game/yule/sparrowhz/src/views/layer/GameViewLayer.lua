...
local posChat = {cc.p(814, 701), cc.p(262, 507), cc.p(301, 319), cc.p(1052, 535)}
...
function GameViewLayer:ctor(scene)
	...
	self._resultLayer = ResultLayer:create(self):addTo(self,GameViewLayer.Z_ORDER_ENUM.LAYER_RESULT):setVisible(false)	--结算框
