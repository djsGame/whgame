 ...
 --bTurnTwoTime为1时，开奖时间为30秒	                   
	...
	local function showAnims(self,i)
		...
		local function callback(resttime)
			...
			print("-------------------------------------------------------")
			print("TotalSceore = ",cumulativeScore)
			print("结算分数 = ",GlobalUserItem.lUserScore)
			print("-------------------------------------------------------")
			self:updateAsset(GlobalUserItem.lUserScore + cumulativeScore)
		end
