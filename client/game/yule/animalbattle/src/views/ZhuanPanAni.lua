	...
	function ZhuanPanAni.zhuanpanPosToKind(index) --从最左边的第一个兔子开始为位置索引开始处，顺时针索引递增
		...
		cmd.JS_TU_ZI,cmd.JS_YAN_ZI,cmd.JS_GE_ZI,  cmd.JS_JIN_SHA,
		cmd.JS_KONG_QUE,cmd.JS_LAO_YING,cmd.JS_YAN_ZI, cmd.JS_GE_ZI, cmd.JS_TU_ZI,cmd.JS_SHI_ZI, cmd.JS_TONG_SHA,
		cmd.JS_XIONG_MAO,  cmd.JS_HOU_ZI,cmd.JS_KONG_QUE, cmd.JS_LAO_YING,cmd.JS_XIONG_MAO, cmd.JS_HOU_ZI, cmd.JS_YIN_SHA,
		cmd.JS_TU_ZI,cmd.JS_YAN_ZI,  cmd.JS_GE_ZI,cmd.JS_KONG_QUE,cmd.JS_SHI_ZI,cmd.JS_XIONG_MAO,cmd.JS_TONG_PEI,
		cmd.JS_LAO_YING,cmd.JS_SHI_ZI, cmd.JS_HOU_ZI 
		}              
		dbg_assert(#tab==28)              
		return tab[index]
	end
