...
--		self._gameView:updateAsset(GlobalUserItem.lUserScore)
		self._gameView:updateAsset(pStatusFree.lUserMaxScore)
...
function GameLayer:OnSubGameFree(dataBuffer)
	...
	self._gameView:updateAsset(GlobalUserItem.lUserScore + self.m_nCumulativeScore)
...
function GameLayer:OnSubPlaceJetton(dataBuffer)  --done
	...
	if pPlaceJetton.wChairID==self:GetMeChairID() then
		...
		print("---------------------------------------------------------------")
		print("游戏结束 GlobalUserItem.lUserScore = ",GlobalUserItem.lUserScore)
		print("游戏结束 self.m_nAllPlayBet = ",self.m_nAllPlayBet)
		print("游戏结束 123 = ",GlobalUserItem.lUserScore - self.m_nAllPlayBet)
		print("---------------------------------------------------------------")		
		self._gameView:updateAsset(GlobalUserItem.lUserScore-self.m_nAllPlayBet)
