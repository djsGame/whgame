...
function GameViewLayer:ctor(scene)
	...
	--弃牌按钮
	self.btGiveUp = ccui.Button:create("bt_game_giveup_0.png","bt_game_giveup_1.png","bt_game_giveup_0.png",ccui.TextureResType.plistType)
	...
	--看牌按钮
	self.btLookCard = ccui.Button:create("bt_game_look_0.png","bt_game_look_1.png","bt_game_look_0.png",ccui.TextureResType.plistType)
		:move(667 - 60  - 192, 50)
		:setEnabled(false)
		:setColor(cc.c3b(158, 112, 8))
	...
	--比牌按钮
	self.btCompare = ccui.Button:create("bt_game_compare_0.png","bt_game_compare_1.png","bt_game_compare_0.png",ccui.TextureResType.plistType)
		:move(667, 50)
		:setEnabled(false)
		:setColor(cc.c3b(158, 112, 8))
	...
	--加注按钮
	self.btAddScore = ccui.Button:create("bt_game_addscore_0.png","bt_game_addscore_1.png","bt_game_addscore_0.png",ccui.TextureResType.plistType)
		:move(667 + 60 + 192, 50)
		:setEnabled(false)
		:setColor(cc.c3b(158, 112, 8))
	...
	--跟注按钮
	self.btFollow = ccui.Button:create("bt_game_follow_0.png","bt_game_follow_1.png","bt_game_follow_0.png",ccui.TextureResType.plistType)
		:move(667 + 60*2 + 192*2, 50)
		:setEnabled(false)
		:setColor(cc.c3b(158, 112, 8))
	...
	for i = 1, 3 do
		...
		self.btChip[i] = ccui.Button:create(strBigChip, strBigChip, "bigchip_gray.png",ccui.TextureResType.plistType)
			:move(79 + 120*(i - 1), 66)
	...
	--牌型按钮
	ccui.Button:create("bt_game_cardtype_0.png","bt_game_cardtype_1.png","bt_game_cardtype_0.png",ccui.TextureResType.plistType)
		:move(162,702)
	...
	--菜单按钮
	ccui.Button:create("bt_game_menu_0.png","bt_game_menu_1.png","bt_game_menu_0.png",ccui.TextureResType.plistType)
		:move(48,702)
	...
	self.m_AreaMenu = display.newSprite("#game_menu_bg.png")
		...
		:addTo(self, 1)
	--设置按钮
	ccui.Button:create("bt_game_set_0.png","bt_game_set_1.png","bt_game_set_0.png",ccui.TextureResType.plistType)
		:move(60,51)
		:setTag(GameViewLayer.BT_SET)
		:addTo(self.m_AreaMenu)
		:addTouchEventListener(btcallback)
	--帮助按钮 
	 local url = yl.HTTP_URL .. "/Mobile/Introduce.aspx?kindid=6&typeid=0"
	 self:getParentNode():getParentNode():createHelpBtn(cc.p(1287, 698), 0, url, top)
	ccui.Button:create("bt_game_help_0.png", "bt_game_help_1.png", "bt_game_help_0.png",ccui.TextureResType.plistType)
		:move(180, 51)
		:setTag(GameViewLayer.BT_HELP)
		:addTo(self.m_AreaMenu)
		:addTouchEventListener(btcallback)
	--聊天按钮
	ccui.Button:create("bt_game_chat_0.png","bt_game_chat_1.png","bt_game_chat_0.png",ccui.TextureResType.plistType)
		:move(300,51)
		:setTag(GameViewLayer.BT_CHAT)
		:addTo(self.m_AreaMenu)
		:addTouchEventListener(btcallback)
	--退出按钮
	ccui.Button:create("bt_game_back_0.png","bt_game_back_1.png","bt_game_back_0.png",ccui.TextureResType.plistType)
		:move(420,51)
	...
	--开始按钮
	self.btReady = ccui.Button:create("game_bt_ready_0.png","game_bt_ready_1.png","game_bt_ready_0.png",ccui.TextureResType.plistType)
...
function GameViewLayer:ShowMenu(bShow)
	...
	if self.m_bShowMenu ~= bShow then
		...
		elseif self.m_AreaMenu:isVisible() == true then
			...
			self.m_AreaMenu:runAction(
				cc.Sequence:create(
					cc.MoveTo:create(0.3,cc.p(-240,692)),
					cc.CallFunc:create(
					function()
