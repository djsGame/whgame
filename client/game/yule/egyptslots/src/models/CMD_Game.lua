...
cmd.GM_THREE					= 5				--小玛丽
cmd.GM_FREE5					= 6				--免费游戏
cmd.GM_FREE10					= 7				--免费游戏
cmd.GM_FREE15					= 8				--免费游戏		

--状态定义
cmd.SHZ_GAME_SCENE_FREE			= 0			--等待开始
cmd.SHZ_GAME_SCENE_ONE			= 101		--水浒传开始
cmd.SHZ_GAME_SCENE_TWO			= 102		--宝藏开始
cmd.SHZ_GAME_SCENE_THREE		= 103		--小玛丽开始
cmd.SHZ_GAME_SCENE_WIAT			= 104		--宝藏开始
cmd.SHZ_GAME_SCENE_FREEGAME		= 105		--免费游戏开始
...
{
	{k = "cbClickIndex", t = "byte", l = {4}},	--点击索引
	{k = "lScore", t = "Score"},				--压线分数
	{k = "cbItemInfo", t = "byte", l = {20}},	--炸弹信息
...
cmd.SHZ_CMD_S_StatusTwo
{
	...
	BYTE							cbTwoMode;							//下注模式
	SCORE							lBet;								//押线下注
	SCORE							lOneGameScore;						//押线得分
	SCORE							lTwoGameScore;						//比倍得分	
