...
local cmd = "game.yule.egyptslots.src.models.CMD_Game"
...
function GameItem:initNotice(  )
    ...
    self:setClippingRegion(cc.rect(0,0,135,135))
...
function GameItem:beginMove( deyTime )
	...
	self.m_pSprite:setPosition(cc.p(60,689+100+100))
    --self.m_pSprite:setPosition(cc.p(0,689))
	--local action1 = cc.MoveBy:create(0.5,cc.p(0,-1512))
	--local action3 = cc.Sequence:create(action1, action2)
	--local action3 = cc.Sequence:create(action2)
	--local actMove = cc.RepeatForever:create(action3)
		
	--[[local actMove = cc.RepeatForever:create(
		cc.Sequence:create(
			--cc.MoveBy:create(0.5,cc.p(0,-1378)),
			--cc.MoveTo:create(0.01,cc.p(105.5,689)),
			cc.MoveBy:create(0.5,cc.p(0,-1512)),
			--cc.MoveTo:create(0.01,cc.p(193,689))
			--)
		)--]]
...
function GameItem:beginJump(  )
	...
	{
		"jump_yaoShi_0%d.png",
		"jump_lanZuan_0%d.png",
		"jump_shiZiJia_0%d.png",
		"jump_renShi_0%d.png",
		"jump_yingZui_0%d.png",
		"jump_gouTou_0%d.png",
		"jump_king_0%d.png",
		"jump_nvGuoWang_0%d.png",
		"jump_bonus_0%d.png",
...
--[[	local strPath = 
	...
	local strPath =
	{
		"common_icon_%d01.png",
		"common_icon_%d02.png",
		"common_icon_%d03.png",
		"common_icon_%d04.png",
		"common_icon_%d05.png",
		"common_icon_%d06.png",
		"common_icon_%d07.png",
		"common_icon_%d08.png",
		"common_icon_%d09.png",
