...
--[[
	...
	cmd.SHZ_CMD_S_RequestQueryResult = 
	{
		...
		{k="cbGameStatus",t="byte"},
		{k="lGameScore",t="score"},
		{k="wChairID",t="word"},-- 控制信息结构体 USERCONTROL--
		{k="controlType",t="int"},
		{k="cbControlData",t="byte"},
		{k="cbControlCount",t="byte"},
		{k="cbZhongJiang",t="byte"},
...
-- 控制: 库存更新通知
	cmd.SHZ_CMD_S_UpdateRoomStorage = 
	{
		{k="lRoomStorageStart",		t="int"}, --//房间起始库存
		{k="lRoomStorageCurrent",	t="int"}, --//房间当前库存
		{k="lRoomStorageInput",		t="int"}, --//房间库存投入
		{k="lRoomStockRecoverScore",t="int"}  --//房间库存输赢
	}

	cmd.RECORD_INFO =
	{
		{k="szRecord", t="string", s = 200}
	}

--操作记录
	cmd.SHZ_CMD_S_OPERATION_RECORD = 
	{
		{k = "operation_record", t = "table", d = cmd.RECORD_INFO, l = {10}}
	}
...
cmd.SUB_S_UPDATE_ROOMUSERLIST		= 116		--更新房间用户列表
cmd.SUB_S_QUERY_STORAGE_RESULT		= 117		--查询库存返回
...
cmd.SHZ_CMD_S_GameStart = 
{
	...
	{k="nFreeScoreCount",t="int"},--免费次数中获得的总金额 nXiaomaliCount
	{k="nCurFreeCount",t="int"},--本轮获得的免费次数 
	{k="nXiaomaliCount",t="int"}--小玛丽次数 
}
...
-- 查询库存结果
cmd.SHZ_CMD_S_CurStorage = 
{
	{k="lCurStorageScore",t="score"}
}
...
--请求更新命令
cmd.SHZ_SUB_C_REQUEST_UDPATE_ROOMUSERLIST	= 32	--请求更新房间用户列表
...
cmd.SHZ_SUB_C_QUERY_STORAGE					= 37    --查询库存
