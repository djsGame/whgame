...
function CannonLayer:initUserInfo(viewpos,userItem)
	...
	score:setString(string.format("%d", self._dataModel.m_secene.lPalyCurScore[1][userItem.wChairID+1])) 
...
function CannonLayer:showCannonByChair( chair )
	...
	--倍数
	local labelMutiple = cc.LabelAtlas:create("1","game_res/mutipleNumCannon.png",14,17,string.byte("0"))
