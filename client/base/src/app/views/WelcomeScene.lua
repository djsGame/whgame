...
local URL_REQUEST = "http://www.pp595.com" --@http_url
--local URL_REQUEST = "http://121.43.173.160" --@http_url
--local URL_REQUEST = "http://192.168.1.88" --@http_url
...
function WelcomeScene:onCreate()
	...
	if nil ~= sp then
		sp = cc.Sprite:create(sloganfile)
		sp:setPosition(appdf.WIDTH/2, 9.5)
		self:addChild(sp)
	end
