...
function TaskItem:ctor(pData)
	...
	--奖励信息
	self.lStandardAwardGold	=0				--奖励游戏币
	self.lStandardAwardMedal=0				--奖励奖牌
	self.lMemberAwardGold	=0				--奖励游戏币
...
function TaskItem:onInit(pData,len)
    ...
    self.lStandardAwardGold		= pData:readscore(int64):getvalue()		--奖励游戏币
    self.lStandardAwardMedal	= pData:readscore(int64):getvalue()		--奖励奖牌
    self.lMemberAwardGold		= pData:readscore(int64):getvalue()		--奖励游戏币
