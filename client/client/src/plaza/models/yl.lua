...
-- 登陆地址列表
--120.25.147.47 www.sopo8.com
--172.16.0.211  演示测试
yl.SERVER_LIST = {}
--table.insert(yl.SERVER_LIST, "121.43.173.160") --@login_ip
--table.insert(yl.SERVER_LIST, "192.168.1.88") --@login_ip
table.insert(yl.SERVER_LIST, "www.pp595.com") --@login_ip
-- 当前地址索引
yl.CURRENT_INDEX = 1
...
--yl.LOGONPORT							= 6002 --@login_port
yl.LOGONPORT							= 8600 --@login_port

--yl.FRIENDPORT							= 6001 --@friend_port
yl.FRIENDPORT							= 8630 --@friend_port
--编译码 
yl.VALIDATE 							= "11E9E77D-C628-4FD6-AC60-91A541DBD5C1" --@compilation

--http请求链接地址
yl.HTTP_URL								= "http://www.pp595.com" --@http_url
--yl.HTTP_URL								= "http://192.168.1.88" --@http_url 110
...
yl.GAME_GENRE_GOLD						= 0x0001		--游戏币类型
...
yl.SUB_GP_USER_CHAOZUO                  = 173	        --用户操作
...
yl.REQUEST_FAILURE_NOGOLD				= 1				--游戏币不足
...
yl.RY_CaoZuo_NOTIFY                      = "ry_game_CaoZuo_notify"  --操作监听
...
yl.SocialShare =
{
	...
	url 								= yl.HTTP_URL,
	AppKey							 	= "56dfc4d567e58ecbf2001ede", --@share_appkey_social
}
...
yl.WeChat = 
{
	AppID 								= "wxc84046b7ad0ef32a", --@wechat_appid_wx
	AppSecret 							= "78cf806d62cd5097e148f118c3cd3055", --@wechat_secret_wx
	-- 商户id
	PartnerID 							= "1490726192", --@wechat_partnerid_wx
	-- 支付密钥					        
	PayKey 								= "yizu1234567891234567891234567891", --@wechat_paykey_wx
	URL 								= yl.HTTP_URL,
}
...
yl.JFT =
{
	...
	--appid				
	JftAppID							= "20161018111009481249", --@jft_appid_jtpay								
	JftAesKey							= "ffbe58771d477b5550daa589c2519398", --@jft_aeskey_jtpay
	JftAesVec 							= "8f76fd45cc7da253", --@jft_aesvec_jtpay
}
