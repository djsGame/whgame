...
function TargetShareLayer:ctor( callback, bNotInsideFriend )
    ...
    btn:setVisible(not bNotInsideFriend)
    btn:setEnabled(not bNotInsideFriend)
    btn:addTouchEventListener( touchFunC )
    panel:getChildByName("Text_1_0_0"):setVisible(not bNotInsideFriend)
