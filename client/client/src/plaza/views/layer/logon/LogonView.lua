...
function LogonView:hideAccountInfo()
	self.m_spAccount:setVisible(true)
	--账号输入
	self.edit_Account:setVisible(true)
	self.edit_Account:setEnabled(true)

	self.m_spPasswd:setVisible(true)
	-- 密码输入
	self.edit_Password:setVisible(true)
	self.edit_Password:setEnabled(true)

	-- 查看密码
	self.m_btnShowPasswd:setVisible(true)
	self.m_btnShowPasswd:setEnabled(true)

	-- 忘记密码
	self.m_btnFgPasswd:setVisible(true)
	self.m_btnFgPasswd:setEnabled(true)

	-- 记住密码
	self.cbt_Record:setVisible(true)
	self.cbt_Record:setEnabled(true)

	-- 注册账号
	self.m_btnRegister:setVisible(true)
	self.m_btnRegister:setEnabled(true)
