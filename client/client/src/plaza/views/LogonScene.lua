...
local gamevideo = ""
if cc.PLATFORM_OS_WINDOWS == targetPlatform then
	gamevideo = "client/src/gamevideo/plaza/src/models/GameVideo.lua"
else
	gamevideo = "client/src/gamevideo/plaza/src/models/GameVideo.luac"
end
if cc.FileUtils:getInstance():isFileExist(gamevideo) then
	if not GameVideo then
		appdf.req(appdf.CLIENT_SRC.."gamevideo.plaza.src.models.GameVideo")
...
function LogonScene:onCreate()
	...
	--背景
    display.newSprite("background_1.png")
