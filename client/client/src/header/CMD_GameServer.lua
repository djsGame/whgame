...
--game_cmd.SUB_GP_USER_CHAOZUO =			173								    
game_cmd.SUB_GP_USER_CHAOZUOJIEGUO =		174								--操作结果
...
--结果返回
game_cmd.CMD_GP_UserChaozuoJieguo = 
{
	{k = "cbJiegguo", t = "byte"},
	{k = "dwUserID", t = "dword"},
	{k = "dwUserScore", t = "dword"},
}
...
-- 通知玩家准备
game_cmd.SUB_GF_NOTICE_READ 		= 502									-- 通知玩家准备
------
--发包结构
--用户聊天
